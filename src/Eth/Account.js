...
export default class Account {
	...
	*/
	...
	/**
	 * ## DCLib.Account.__sendEth(to, amount)
	 * sendBets from current account to another account
	 * @ignore
	 * @example
	 * DCLib.Account.__sendEth('0xAb5...', 10, function(receipt){ ... }) // callback is optional
	 * 
	 * @param {string} to - Byte32 addres
	 * @param {number} amount - value Ethereum
	 * @param {onTxMined} CB - callback, when transacrion mined
	 * @returns {Promise.receipt} - return web3.send promise,
	 * 
	 * @extends {Account}
	 */
	__sendEth(to, amount, callback){
